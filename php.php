...
return [
  ...
  'ar-KW'         =>  array( 'English'  => 'Arabic (Kuwait)',                   'native' => 'لعربية (الكويت)'),
    'ar-LB'         =>  array( 'English'  => 'Arabic (Lebanon)',                   'native' => 'لعربية (الأردن)'),
    'ar-LY'         =>  array( 'English'  => 'Arabic (Libya)',                   'native' => 'لعربية (الأردن)'),
    'ar-MA'         =>  array( 'English'  => 'Arabic (Morocco)',                   'native' => 'لعربية (الأردن)'),
    'ar-OM'         =>  array( 'English'  => 'Arabic (Oman)',                   'native' => 'لعربية (الأردن)'),
    'ar-QA'         =>  array( 'English'  => 'Arabic (Qatar)',                   'native' => 'لعربية (الأردن)'),
    'ar-SA'         =>  array( 'English'  => 'Arabic (Saudi Arabia)',                   'native' => 'لعربية (الأردن)'),
    'ar-SY'         =>  array( 'English'  => 'Arabic (Syria)',                   'native' => 'لعربية (الأردن)'),
    'ar-TN'         =>  array( 'English'  => 'Arabic (Tunisia)',                   'native' => 'لعربية (الأردن)'),
    'ar-AE'         =>  array( 'English'  => 'Arabic (U.A.E.)',                   'native' => 'لعربية (الأردن)'),
    'ar-YE'         =>  array( 'English'  => 'Arabic (Yemen)',                   'native' => 'لعربية (الأردن)'),
    'hy-AM'         =>  array( 'English'  => 'Armenian (Armenia)',                   'native' => 'لعربية (الأردن)'),
